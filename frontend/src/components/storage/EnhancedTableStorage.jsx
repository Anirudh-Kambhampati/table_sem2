...
import TableToolbarStorage from "./TableToolbarStorage";
...
const EnhancedTableStorage = ({
  ...
  const deleteUserHandler = (event) => {
    //Insert Modal Here with ternary operator
  ...
  const addStorageHandler = (storage) => {
    const newData = data.concat([storage]);
    setData(newData);
  };
  ...
  return (
    <TableContainer>
      <TableToolbarStorage
        ...
        addStorageHandler={addStorageHandler}
...
EnhancedTableStorage.propTypes = {
...
export default EnhancedTableStorage;
