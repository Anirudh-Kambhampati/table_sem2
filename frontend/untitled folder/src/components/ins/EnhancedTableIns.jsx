...
import TableToolbarIns from "./TableToolbarIns";
...
const EnhancedTableIns = ({
  ...
  const addInstrumentHandler = (instrument) => {
    const newData = data.concat([instrument]);
    setData(newData);
  };
...
export default EnhancedTableIns;
